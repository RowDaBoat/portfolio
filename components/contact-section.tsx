      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center relative z-20">
          <Link
            ...
            className="bg-transparent border-2 border-golden text-golden font-semibold px-6 lg:px-8 py-3 neon-button hover:bg-golden hover:text-black w-auto flex-shrink-0 relative z-30 flex items-center rounded-md transition-all duration-300"
          >
