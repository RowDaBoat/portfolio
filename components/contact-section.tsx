    ...
    <section id="contact" className="py-20 relative z-10">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center max-w-4xl mx-auto">
          <Button
            className="bg-golden hover:bg-[#FFD700] text-black font-semibold px-6 py-3 neon-button flex-shrink-0"
            asChild
          >
          ...
          >
            <Link href="https://t.me/MrRowboto" target="_blank" rel="noopener noreferrer">
              <Image
                ...
                alt="Telegram"
                className="w-5 h-5 mr-2 filter brightness-0"
              />
              Telegram
            </Link>
          </Button>
          ...
          >
            <Link href="https://njump.me/row@alephia.tech" target="_blank" rel="noopener noreferrer">
              <Image
                ...
                alt="Nostrich"
                className="w-9 h-6 mr-2 filter brightness-0"
              />
              Nostr
            </Link>
          </Button>
