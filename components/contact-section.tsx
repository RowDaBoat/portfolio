      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center relative z-20">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-transparent border-2 border-golden text-golden font-semibold px-6 lg:px-8 py-3 neon-button hover:bg-yellow-400 hover:text-black w-auto flex-shrink-0 relative z-30 h-10 hover:[&>svg]:text-black"
          >
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-transparent border-2 border-golden text-golden font-semibold px-6 lg:px-8 py-3 neon-button hover:bg-yellow-400 hover:text-black w-auto flex-shrink-0 relative z-30 h-10 hover:[&>img]:brightness-0"
          >
            <Image
